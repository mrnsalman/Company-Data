        ...
        <div id="main" class="main-content bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
            ...
            <div class="bg-gray-800 pt-3">
                <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white flex justify-between container items-baseline">
                    <h1 class="font-bold pl-2">Edit Industry</h1>
                ...
                <div class="flex flex-col py-32 sm:px-10 md:px-10 lg:px-10 w-full xl:w-2/3 h-screen container mx-auto">
                    ...
                    <form method="POST" action="{{ route('industries.update', $industry->id) }}">
                        ...
                        <!-- Industry ID -->
                        <div class="mt-4">
                            <x-input id="id" class="block mt-1 w-full" type="hidden" name="id" :value="old('industry_id',$industry->id)" />
                        </div>
                        <!-- Industry Name -->
                        <div class="mt-4">
                            <x-label for="industry_name" :value="__('Industry Name')" />
            
                            <x-input id="industry_name" class="block mt-1 w-full" type="text" name="industry_name" :value="old('industry_name',$industry->industry_name)" />
                        </div>
